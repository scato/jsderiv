...
exports['test LeftExpr'] = function(test) {
    test.equal("c.Not(g.InstanceOf(INT))", Not([InstanceOf(["INT"])]).toJavascript());
    test.equal("l.Look(g.InstanceOf(INT))", Look([InstanceOf(["INT"])]).toJavascript());
...
exports['test Terminal'] = function(test) {
    ...
    test.equals("g.InstanceOf(STRING)", InstanceOf(["STRING"]).toJavascript());
