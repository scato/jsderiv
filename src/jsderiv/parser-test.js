...
(function($default) {
    ...
    Parser.prototype.Test = function() {
        return $cache = $cache || g.Ref(function() {
            return c.Red(c.Seq(c.Seq(c.Seq(c.Seq(c.Seq(c.Ignore(g.Literal("test")), g.InstanceOf(LITERAL)), c.Ignore(g.Literal("{"))), this.StartDeclaration()), c.Any(this.Assertion())), c.Ignore(g.Literal("}"))), Test);
        }.bind(this), 'Test');
    };
...
(function($default) {
    ...
    Parser.prototype.RuleIdentifier = function() {
        return $cache = $cache || g.Ref(function() {
            return c.Or(c.Seq(c.Seq(g.InstanceOf(ID), c.Ignore(g.Literal("."))), g.InstanceOf(ID)), c.Seq(c.Seq(g.InstanceOf(ID), c.Ignore(g.Literal("."))), c.Ignore(g.Literal("start"))));
...
(function($default) {
    ...
    Parser.prototype.NodeList = function() {
        return $cache = $cache || g.Ref(function() {
            return c.Or(c.Red(c.Seq(c.Seq(g.Literal("("), c.Maybe(c.Seq(this.Node(), c.Any(c.Seq(c.Ignore(g.Literal(",")), this.Node()))))), g.Literal(")")), NodeList), g.InstanceOf(LITERAL));
        }.bind(this), 'NodeList');
    };
...
(function($default) {
    ...
    Parser.prototype.NodeSet = function() {
        return $cache = $cache || g.Ref(function() {
            return c.Or(c.Red(c.Seq(c.Seq(g.Literal("{"), c.Maybe(c.Seq(this.NodeList(), c.Any(c.Seq(c.Ignore(g.Literal(",")), this.NodeList()))))), g.Literal("}")), NodeSet), c.Red(this.NodeList(), NodeSet));
        }.bind(this), 'NodeSet');
    };
...
(function($default) {
    ...
    Parser.prototype.Node = function() {
        return $cache = $cache || g.Ref(function() {
            return c.Seq(g.InstanceOf(ID), this.NodeList());
        }.bind(this), 'Node');
    };
