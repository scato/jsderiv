    ...
    if(this.fixed.derive !== undefined) {
        ...
        [Null(), Empty()].forEach(function(fixed) {
            if(found === undefined) {
                ...
                if(this.resolve().derive(element).equals(fixed)) {
                    found = fixed;
                }
        ...
        if(found !== undefined) {
            ...
            self.define(id, this.resolve().derive(element), null);
...
function Def(Ref, defcons, func) {
    ...
    Ref.define = function(id, expr, cons) {
        ...
        if(cons === null) {
            ...
            Ref.definitions[id] = Red(expr, func(cons));
        }
